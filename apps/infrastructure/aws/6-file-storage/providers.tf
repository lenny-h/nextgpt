...
terraform {
  ...
  #   key            = "terraform/state/6-file-storage/terraform.tfstate"
  #   region         = "us-east-1"
...
data "terraform_remote_state" "core" {
  ...
  config = {
    path = "../4-core-with-firecrawl/terraform.tfstate" # Update to ../4-core-with-firecrawl/terraform.tfstate if using Firecrawl
  }
}
