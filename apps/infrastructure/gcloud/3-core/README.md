# Step 2: Core Infrastructure (Without Firecrawl)

This directory sets up the core application infrastructure WITHOUT Firecrawl services.
...
- This configuration does NOT include Firecrawl services
- For Firecrawl support, use `3-core-with-firecrawl/` instead
