...
resource "cloudflare_r2_bucket_cors" "files_bucket" {
  account_id  = var.cloudflare_account_id
  bucket_name = cloudflare_r2_bucket.files_bucket.name
...
resource "cloudflare_r2_bucket_cors" "temporary_files_bucket" {
  account_id  = var.cloudflare_account_id
  bucket_name = cloudflare_r2_bucket.temporary_files_bucket.name
