    ...
    if (part.state === "input-available") {
      return (
        <div className="bg-muted/30 flex items-start gap-2 rounded-md border p-2">
          <Globe className="text-primary mt-0.5" size={16} />
          <div className="flex-1">
            <p className="mb-1 text-xs font-medium">Retrieving web pages:</p>
            ...
            <div className="space-y-1 p-2 text-xs">
              {pages.map((page, index) => (
                ...
                >
                  ...
                  {page.pageContent && (
                    <p className="text-muted-foreground ml-5 mt-1 line-clamp-3 text-xs">
