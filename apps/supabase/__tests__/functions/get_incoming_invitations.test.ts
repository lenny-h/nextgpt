...
describe("get_incoming_invitations function", () => {
  ...
  it("should retrieve incoming user invitations", async () => {
    const { data, error } = await user2Client.rpc("get_incoming_invitations", {
  ...
  it("should retrieve incoming course maintainer invitations", async () => {
    const { data, error } = await user2Client.rpc("get_incoming_invitations", {
  ...
  it("should retrieve incoming bucket maintainer invitations", async () => {
    const { data, error } = await user2Client.rpc("get_incoming_invitations", {
  ...
  it("should not allow a user to see another user's incoming invitations", async () => {
    const { data, error } = await user1Client.rpc("get_incoming_invitations", {
      invitation_type: "user",
    });
    if (error) throw error;
